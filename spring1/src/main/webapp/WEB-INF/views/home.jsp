...
<body>
    <header>
        <h1>Home</h1>
        <h2>${now}</h2>
        <!-- img alt="사진" src="/spring1/images/img1.jpg" -->
        <!-- img alt="사진" src="./images/img1.jpg"  -->
        <c:url var="image" value="/images/img1.jpg" />
        <img alt="사진" src="${image}" />
        <!-- img src="http://localhost:8080/spring1/images/img1.jpg" -->
    </header>
